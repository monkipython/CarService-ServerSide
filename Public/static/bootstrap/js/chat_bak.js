...
var FACE_MAP = {
    '[开心]' : '<img class="emoji-message" src="http://121.40.92.53/ycbb/Uploads/Emoji/1.png"/>',
    '[委屈]' : '<img class="emoji-message" src="http://121.40.92.53/ycbb/Uploads/Emoji/2.png"/>',
    '[礼物]' : '<img class="emoji-message" src="http://121.40.92.53/ycbb/Uploads/Emoji/3.png"/>',
    '[惊恐]' : '<img class="emoji-message" src="http://121.40.92.53/ycbb/Uploads/Emoji/4.png"/>',
    '[咖啡]' : '<img class="emoji-message" src="http://121.40.92.53/ycbb/Uploads/Emoji/5.png"/>',
    '[疑问]' : '<img class="emoji-message" src="http://121.40.92.53/ycbb/Uploads/Emoji/6.png"/>',
    '[生气]' : '<img class="emoji-message" src="http://121.40.92.53/ycbb/Uploads/Emoji/7.png"/>',
    '[很强]' : '<img class="emoji-message" src="http://121.40.92.53/ycbb/Uploads/Emoji/8.png"/>',
    '[狂吐]' : '<img class="emoji-message" src="http://121.40.92.53/ycbb/Uploads/Emoji/9.png"/>',
    '[呼呼]' : '<img class="emoji-message" src="http://121.40.92.53/ycbb/Uploads/Emoji/10.png"/>',
    '[可爱]' : '<img class="emoji-message" src="http://121.40.92.53/ycbb/Uploads/Emoji/11.png"/>',
    '[鄙视]' : '<img class="emoji-message" src="http://121.40.92.53/ycbb/Uploads/Emoji/12.png"/>',
    '[很弱]' : '<img class="emoji-message" src="http://121.40.92.53/ycbb/Uploads/Emoji/13.png"/>',
    '[真棒]' : '<img class="emoji-message" src="http://121.40.92.53/ycbb/Uploads/Emoji/14.png"/>',
    '[钱币]' : '<img class="emoji-message" src="http://121.40.92.53/ycbb/Uploads/Emoji/15.png"/>',
    '[勉强]' : '<img class="emoji-message" src="http://121.40.92.53/ycbb/Uploads/Emoji/16.png"/>',
    '[流汗]' : '<img class="emoji-message" src="http://121.40.92.53/ycbb/Uploads/Emoji/17.png"/>',
    '[睡觉]' : '<img class="emoji-message" src="http://121.40.92.53/ycbb/Uploads/Emoji/18.png"/>',
    '[爱你]' : '<img class="emoji-message" src="http://121.40.92.53/ycbb/Uploads/Emoji/19.png"/>',
    '[灯泡]' : '<img class="emoji-message" src="http://121.40.92.53/ycbb/Uploads/Emoji/20.png"/>',
    '[我喷]' : '<img class="emoji-message" src="http://121.40.92.53/ycbb/Uploads/Emoji/21.png"/>',
    '[阴险]' : '<img class="emoji-message" src="http://121.40.92.53/ycbb/Uploads/Emoji/22.png"/>',
    '[好酷]' : '<img class="emoji-message" src="http://121.40.92.53/ycbb/Uploads/Emoji/23.png"/>',
    '[大怒]' : '<img class="emoji-message" src="http://121.40.92.53/ycbb/Uploads/Emoji/24.png"/>',
    '[玫瑰]' : '<img class="emoji-message" src="http://121.40.92.53/ycbb/Uploads/Emoji/25.png"/>',
    '[笑靥]' : '<img class="emoji-message" src="http://121.40.92.53/ycbb/Uploads/Emoji/26.png"/>',
    '[滑稽]' : '<img class="emoji-message" src="http://121.40.92.53/ycbb/Uploads/Emoji/27.png"/>',
    '[亲你]' : '<img class="emoji-message" src="http://121.40.92.53/ycbb/Uploads/Emoji/28.png"/>',
    '[好冷]' : '<img class="emoji-message" src="http://121.40.92.53/ycbb/Uploads/Emoji/29.png"/>',
    '[黑线]' : '<img class="emoji-message" src="http://121.40.92.53/ycbb/Uploads/Emoji/30.png"/>',
    '[狂汗]' : '<img class="emoji-message" src="http://121.40.92.53/ycbb/Uploads/Emoji/31.png"/>',
    '[惊哭]' : '<img class="emoji-message" src="http://121.40.92.53/ycbb/Uploads/Emoji/32.png"/>',
    '[大哭]' : '<img class="emoji-message" src="http://121.40.92.53/ycbb/Uploads/Emoji/33.png"/>',
    '[金钱]' : '<img class="emoji-message" src="http://121.40.92.53/ycbb/Uploads/Emoji/34.png"/>',
    '[哈哈]' : '<img class="emoji-message" src="http://121.40.92.53/ycbb/Uploads/Emoji/35.png"/>',
    '[音乐]' : '<img class="emoji-message" src="http://121.40.92.53/ycbb/Uploads/Emoji/36.png"/>',
    '[难过]' : '<img class="emoji-message" src="http://121.40.92.53/ycbb/Uploads/Emoji/37.png"/>',
    '[乖乖]' : '<img class="emoji-message" src="http://121.40.92.53/ycbb/Uploads/Emoji/38.png"/>',
    '[胜利]' : '<img class="emoji-message" src="http://121.40.92.53/ycbb/Uploads/Emoji/39.png"/>',
    '[吐舌]' : '<img class="emoji-message" src="http://121.40.92.53/ycbb/Uploads/Emoji/40.png"/>',
    '[彩虹]' : '<img class="emoji-message" src="http://121.40.92.53/ycbb/Uploads/Emoji/41.png"/>',
    '[呵呵]' : '<img class="emoji-message" src="http://121.40.92.53/ycbb/Uploads/Emoji/42.png"/>',
    '[咦咦]' : '<img class="emoji-message" src="http://121.40.92.53/ycbb/Uploads/Emoji/43.png"/>',
    '[惊讶]' : '<img class="emoji-message" src="http://121.40.92.53/ycbb/Uploads/Emoji/44.png"/>'
};
...
function showEmojiBox(){ 
	var lists = "";
	for(var i in FACE){
		lists += '<img class="emoji-face-icon" onClick="javascript:sendEmo(this);" title="'+i+'" src="http://121.40.92.53/ycbb/Uploads/Emoji/'+FACE[i]+'.png"/>';
	}
/* 	console.log(lists); */
...
var image_api = "http://121.40.92.53/ycbb/index.php/App/Chat/uploadPic";
var image_src = "http://121.40.92.53/ycbb/Uploads"; 
...
function onConnect(status){    
    if (status == Strophe.Status.CONNECTING) {
            ...
            $("<li class='non-msg'><div class='na-msg'><img src='http://121.40.92.53/ycbb/Public/static/bootstrap/img/loading.gif'/></div></li>").insertBefore('.push-msg');
            $("<li class='non'><div class='na-msg'><img src='http://121.40.92.53/ycbb/Public/static/bootstrap/img/loading.gif'/></div></li>").insertBefore('.push-contact');
...
var initAudio = function(){
	...
	audio.src = "http://121.40.92.53/ycbb/Public/static/bootstrap/audio/alert.wav";
...
function getDemandCount(type){
	$.ajax({
		url:"http://121.40.92.53/ycbb/index.php/App/MerDemand/member_demand_list", 
		type: "POST",
...
function insertDemand(id){
	...
	$.ajax({
		url:"http://121.40.92.53/ycbb/index.php/App/MerDemand/get_member_demand", 
		type: "POST",
...
function getOrderInComplete(type){
	...
	$.ajax({
		url:"http://121.40.92.53/ycbb/index.php/App/MerOrder/merchant_order_list",
		type: "POST",
...
function getUserImg(fid){
	var v = null;
	$.ajax({
	    url: "http://121.40.92.53/ycbb/index.php/App/Chat/getChatUserData",
	    type: "POST",
	    async:false,
	    data: {jid: fid},
...
/*     connection.rawOutput = function (data) { console.log('SEND: ' + data); }; */
    ...
    $('.add-user-btn').click(function(){
	    ...
	    $.ajax({
		    url: "http://121.40.92.53/ycbb/index.php/App/Chat/searchFriend",
		    type: "POST",
		    async:false,
		    data: {phone: phone},
		    success: function(data){
