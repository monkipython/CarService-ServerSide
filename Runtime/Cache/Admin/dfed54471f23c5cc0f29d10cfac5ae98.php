<?php if (!defined('THINK_PATH')) exit();?><div class="page">
	...
	<form method="post" action="/index.php/Admin/Category/update/navTabId/Category.index" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone)">
