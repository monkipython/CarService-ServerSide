<?php if (!defined('THINK_PATH')) exit();?><form id="pagerForm" action="/index.php/Admin/Config" method="post">
...
<div class="page">
    <div class="pageHeader">
        <form onsubmit="return navTabSearch(this);" action="/index.php/Admin/Config" method="post">
            <div class="searchBar">
    ...
    <div class="pageContent">
        <div class="panelBar">
            <ul class="toolBar">
            	<li><a class="add" href="/index.php/Admin/Config/add" target="dialog" mask="true" warn="请选择节点" width="700" height="400"><span>新增</span></a></li>
               <li><a class="edit" href="/index.php/Admin/Config/edit/id/{sid_node}" target="dialog" mask="true" warn="请选择节点" width="700" height="400"><span>查看</span></a></li> 
            	<li><a class="delete" href="/index.php/Admin/Config/foreverdelete/id/{sid_node}/navTabId/Config.index" target="ajaxTodo"  title="你确定要删除吗？" warn="请选择节点" ><span>删除</span></a></li> 
            </ul>
        </div>
