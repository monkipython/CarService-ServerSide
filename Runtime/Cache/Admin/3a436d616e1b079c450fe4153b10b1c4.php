<?php if (!defined('THINK_PATH')) exit();?><form id="pagerForm" action="/index.php/Admin/Conf" method="post">
...
<div class="page">
    <div class="pageHeader">
        <form onsubmit="return navTabSearch(this);" action="/index.php/Admin/Conf" method="post">
            <div class="searchBar">
    ...
    <div class="pageContent">
        <div class="panelBar">
            <ul class="toolBar">
            	<li><a class="add" href="/index.php/Admin/Conf/add" target="dialog" mask="true" warn="请选择节点" width="700" height="400"><span>新增</span></a></li>
               <li><a class="edit" href="/index.php/Admin/Conf/edit/id/{sid_node}" target="dialog" mask="true" warn="请选择节点" width="700" height="400"><span>查看</span></a></li> 
