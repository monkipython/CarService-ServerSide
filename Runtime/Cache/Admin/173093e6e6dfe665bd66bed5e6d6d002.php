<?php if (!defined('THINK_PATH')) exit();?><form id="pagerForm" action="/index.php/Admin/AuthGroup" method="post">
...
<div class="page">
    <div class="pageHeader">
        <form onsubmit="return navTabSearch(this);" action="/index.php/Admin/AuthGroup" method="post">
            <div class="searchBar">
    ...
    <div class="pageContent">
        <div class="panelBar">
            <ul class="toolBar">
            	<li><a class="add" href="/index.php/Admin/AuthGroup/add" target="dialog" mask="true" warn="请选择节点" width="700" height="400"><span>新增</span></a></li>
            </ul>
        </div>
        <table class="list" width="100%" layoutH="116">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr target="sid_node" rel="<?php echo ($vo['id']); ?>">
                    ...
                    <td><a href="/index.php/Admin/AuthGroup/edit/id/<?php echo ($vo['id']); ?>/furl/<?php echo ($furl); ?>" target="navTab" rel="AuthGroup.index">查看详细</a></td>
