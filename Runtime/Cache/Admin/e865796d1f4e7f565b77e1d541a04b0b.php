<?php if (!defined('THINK_PATH')) exit();?><div class="page">
    <div class="pageContent">
        ...
        <form method="post" action="/index.php/Admin/Config/update/navTabId/Config.index/callbackType/closeCurrent" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone)">
