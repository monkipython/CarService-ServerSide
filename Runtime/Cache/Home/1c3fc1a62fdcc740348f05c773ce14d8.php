		...
		<div class="row">
			<div class="col-md-12 text-left" >
				<div class="btn-group" role="group">
				  <a href="/Plateform/unbid" class="btn btn-info">未报价</a>
				  <a href="/Plateform/bid" class="btn btn-info active">已报价</a>
				</div>
			</div>
		</div>
				  ...
				  <table class="table" id="project-table">
				  	...
				  	<tbody>
					   <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						  	...
						  	<td>
						  	<?php if($vo['demand_status'] == 0): ?><span class="color-green">等待用户确认</span>
						  	...
						  	<td>
						  	<a href="/Plateform/updateBid/demand/<?php echo ($vo['id']); ?>/type/2" class="btn btn-info btn-sm">查看</a>
						  	</if>
                                                        </td>
