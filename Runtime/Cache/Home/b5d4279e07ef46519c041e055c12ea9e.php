				...
				<div class="col-md-9">
					<form class="form-horizontal">
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-6">
					      <input type="text" class="form-control" id="companyName" placeholder="请填写公司名称" value="<?php echo ($data['merchant_name']); ?>">
					    </div>
					  </div>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-6">
					      <input type="text" class="form-control" id="charge" placeholder="请填写公司负责人" value="<?php echo ($data['manager']); ?>">
					    </div>
					  </div>
					  	<div class="form-group">
					    <label for="tel" class="col-sm-2 control-label">公司座机</label>
					    <div class="col-sm-6">
					      <input type="text" class="form-control" id="tel" placeholder="请填写公司座机号码" value="<?php echo ($data['tel']); ?>">
					    </div>
					  </div>
					  	<div class="form-group">
					  ...
					  <div class="form-group">
					    ...
					    <?php echo ($data['addr']['province']); ?>,<?php echo ($data['addr']['city']); ?>,<?php echo ($data['addr']['area']); ?>
					      <input type="text" class="form-control" id="addr" placeholder="请填写公司地址" value="<?php echo ($data['address']); ?>">
					    </div>
					  </div>
					   <div class="form-group">
					    ...
					    <div class="col-sm-6">
					      ...
					      <textarea type="text" class="form-control"  rows="5" name="dec"  placeholder="请填写公司简介" ><?php echo ($data['intro']); ?></textarea>
					    </div>
					  </div>
					     <div class="form-group">
