			...
			<div class="col-md-12" style=" margin-top:10px;border:1px solid #ccc;">
				<form class="form-horizontal">
				    ...
				    <div class="col-sm-10">
						...
						<button type="button" id ="inputService" class="btn btn-primary btn-lg disabled" style="background:rgb(248,125,34);" >
							<?php echo ($data['service_name']); ?>
								<?php if($data['effect'] == 1): ?>(<span class="color-green">审核通过</span>)
							<?php else: ?>
								(<span class="color-red">审核中</span>)<?php endif; ?>
						</button>
					
						<input name="service_id" value="<?php echo ($data['service_id']); ?>" type="hidden"/>
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-10 ">
				      <input
						type="number" name="day" value="<?php echo ($data['day']); ?>" class="time-format input-style"  
						 /> 天
						 <input
						type="number" name="hour" value="<?php echo ($data['hour']); ?>" class="time-format input-style"
						 /> 时
						 <input
						type="number" name="min" value="<?php echo ($data['min']); ?>" class="time-format input-style"
						 /> 分
				    </div>
				  </div>
				   <div class="form-group">
				    ...
				    <div class="col-sm-10 ">
				      <input
						type="number" name="price" value="<?php echo ($data['price']); ?>" class="time-format input-style"  
						 /> 元
				    ...
				    <div class="col-sm-10 ">
				      <textarea class="form-control" 
							...
							placeholder="对该项目进行描述" name="dec"><?php echo ($data['intro']); ?></textarea>
					   ...
					   <label for="file_upload" class="col-xs-4 col-sm-3 control-label">上传图片：</label>
					    <div class="col-xs-12 col-sm-8">
							...
							<div class="col-xs-12" id ="uploadThumb">
								<?php if(is_array($data["img"])): $i = 0; $__LIST__ = $data["img"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$is): $mod = ($i % 2 );++$i;?><div class="col-xs-4 orgnize"><img src="<?php echo ($is['hs']); ?>" class="img-responsive" /></div><?php endforeach; endif; else: echo "" ;endif; ?>
							</div>
