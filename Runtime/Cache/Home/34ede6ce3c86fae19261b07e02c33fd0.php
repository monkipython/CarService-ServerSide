		...
		<div class="row">
			<div class="col-md-12 text-left">
				<div class="btn-group" role="group" >
				  <a href="/Plateform/unbid" class="btn btn-info active">未报价</a>
				  <a href="/Plateform/bid" class="btn btn-info">已报价</a>
				</div>
			</div>
		</div>
			<div id="frame-view" class="col-md-12" style="text-align:center; margin-top:10px;">
				<div class="panel panel-default col-md-12" id="ycbb-project-list-panel">
				  ...
				  <table class="table" id="project-table">
					 ...
					 <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo['demand_status'] != 0): ?><tr style="color:#cccccc;" >
					 	<?php else: ?>
					 	<tr ><?php endif; ?>
						  	<td><?php echo ($vo['nick_name']); ?></td>
						  	<td><?php echo (substr($vo['addtime'],5)); ?></td>
						  	<td><?php echo ($vo['service_name']); ?></td>
						  	<td><?php echo ($vo['offer_price_num']); ?>家报价</td>
						  	<td>
						  	<?php if($vo['demand_status'] == 0): ?><span class="color-green">正常</span>
						  	<?php elseif($vo['demand_status'] == 1): ?>
						  		<span class="color-red">需求被抢</span>
						  	<?php elseif($vo['demand_status'] == 2): ?>	
						  		<span class="color-grep">取消需求</span>
						  		
						  	<?php elseif($vo['demand_status'] == 3): ?>
						  		<span class="color-grep">需求过期</span><?php endif; ?>
						  	</td>
						  	<td><p><?php echo ($vo['distance']); ?>公里</p></td>
						  	<td>
						  	<?php if($vo['demand_status'] == 0): ?><a href="/Plateform/updateBid/demand/<?php echo ($vo['id']); ?>/type/1" class="btn btn-info btn-sm">抢单</a>
						  	<?php else: ?>
						  	<a href="javascript:;" class="btn btn-info btn-sm disabled">抢单</a><?php endif; ?>
						  	</td>
