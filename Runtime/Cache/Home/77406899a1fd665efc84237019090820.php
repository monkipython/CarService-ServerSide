		...
		<div class="row">
			<div class="col-md-12 text-left">
				<div class="btn-group" role="group" >
				  <a href="/Plateform/addProject" class="btn btn-info ">添加项目</a>
				...
				<div class="panel panel-default col-md-12" id="ycbb-project-list-panel">
				  ...
				  <table class="table" id="project-table">
					 ...
					 <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						  	...
						  	<td><?php echo (todaydiff($vo['timeout'])); ?></td>
						  	<td><?php if($vo['classid'] == 1): ?><span class="">车辆美容</span>
						  	<?php elseif($vo['classid'] == 2): ?>
						  		<span class="">车辆装饰</span>
						  	<?php elseif($vo['classid'] == 3): ?>	
						  		<span class="">车辆维修</span>
						  		
						  	<?php elseif($vo['classid'] == 4): ?>
						  		<span class="">车辆改装</span><?php endif; ?></td>
						  	<td>
						  	<?php if($vo['effect'] == 0): ?><span class="color-red">审核中</span>
						  	<?php elseif($vo['effect'] == 1): ?>
						  		<span class="color-green">审核通过</span><?php endif; ?>
						  	</td>
						 
						  	<td>
						  
						  	<a href="/Plateform/projectdetail/id/<?php echo ($vo['service_id']); ?>" class="btn btn-info btn-sm">查看</a>
						  	</td>
