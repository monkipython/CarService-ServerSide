...
<html>
    <head>
        <meta charset="UTF-8">
        <title>搜索：<?php echo ($keyword); ?></title>
      ...
      $(function () { 
		...
		<div class="row">
			<div class="col-md-12 text-left">
				<span class="theme-h5">搜索到的问题（<?php echo ($count); ?>）</span>
			</div>
		</div>
		<div class="row">
			<div class="col-md-12" style="text-align:center; margin-top:10px;">
				<div class="col-md-8">
					...
					<?php if(!empty($answer)): if(is_array($answer)): $i = 0; $__LIST__ = $answer;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-md-12 text-left " style="border-bottom:1px dotted #DBDBDB;" >
									<div class="col-md-2" >
									...
									<div class="col-md-10" style="margin-left:-5px;padding:20px 0px 10px 0px;">
										...
										<div class="col-md-12" style="text-inde">
										<a href="/Answer/detail/id/<?php echo ($vo['id']); ?>" class=" answer-title">
											<?php echo (msubstr($vo['title'],0,60,'utf-8',true)); ?>
											</a>
										</div>
										...
										<div class="col-md-12  font-grep">
											...
											<div class="col-md-3">
												回答（<?php echo ($vo['answer_num']); ?>）
											</div>
											<div class="col-md-4">
												分类（<?php echo ($vo['pidname']); ?>）
											</div>
											<div class="col-md-4">
											 <?php echo ($vo['addtime']); ?>
											</div>
									...
									<?php if(!empty($vo['last_answer'])): ?><div class="col-md-12">
										<div class="col-md-12">
											最近一条回复：
										</div>
										<div class="col-md-11 col-md-offset-1">
											<div class="col-md-2">
											<a href="/user/detail/id/<?php echo ($vo['last_answer']['system_user_id']); ?>">
											<img src="<?php echo ((isset($vo['last_answer']['header']) && ($vo['last_answer']['header'] !== ""))?($vo['last_answer']['header']):'/Public/img/default_user.jpg'); ?>" width="50" height="50" class="  img-circle "/>
											</a>
											</div>
											<div class="col-md-9" class="answer-title" style="margin-left:-15px;" >
												<div class="col-md-12">
													<span class="theme-h6"><?php echo ($vo['last_answer']['name']); ?>：</span>
												</div>
												
												<div class="col-md-8" style="text-indent:2em;" >
													
													<?php echo (msubstr($vo['last_answer']['reply_content'],0,60,'utf-8',true)); ?>
													
												</div>
												<div class="col-md-4">
													<?php echo ($vo['last_answer']['addtime']); ?>
												</div>
											</div>
							...
							<?php else: ?>
								<div class="col-md-12 text-left " style="border-bottom:1px dotted #DBDBDB;" >
									<div class="col-md-2" >
										...
										<img src="/Public/img/default_user.jpg" width="80" height="80" class="img-circle header-img"/>
										
									</div>
									<div class="col-md-10" style="margin-left:-5px;padding:40px 0px 10px 0px;">
										<div class="col-md-12">
