			...
			<div class="col-md-12" style="text-align:center; margin-top:10px;">
				<div class="col-md-8">
					<div class="col-md-12" style="border:1px solid #d9d9d9;">
						<?php if(is_array($answer)): $i = 0; $__LIST__ = $answer;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-md-12 text-left " style="border-bottom:1px dotted #DBDBDB;" >
									<div class="col-md-2" >
